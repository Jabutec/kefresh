    ...
    <main className="min-h-screen bg-[#fdf6f0] pb-32">
      ...
      <div className="px-6 pt-6 flex flex-col gap-6">
        ...
        <div>
          ...
          <div className="bg-white rounded-2xl px-4 py-3 border border-[#d4537e]">
            <div className="flex justify-between items-center">
              <div>
                <p className="text-sm text-[#2c2c2a] font-medium">Box braids</p>
                <p className="text-xs text-[#b4b2a9] mt-0.5">3 hrs</p>
              </div>
              <p className="text-sm font-medium text-[#d4537e]">R450</p>
            </div>
          </div>
        </div>
...
className={`text-center py-3 rounded-2xl border text-sm cursor-pointer ${
  selectedTime === time
    ? "bg-[#d4537e] border-[#d4537e] text-white font-medium"
    : "bg-white border-[#e8e4df] text-[#2c2c2a]"
}`}
              >
                {time}
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#e8e4df] px-6 py-4">
        <a href="/confirmation" className="w-full bg-[#d4537e] text-white py-3 rounded-2xl text-sm font-medium hover:bg-[#c4436e] transition-colors block text-center">
